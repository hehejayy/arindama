      ...
      >
        ...
        <div className="relative mt-8">
          <button
            ...
            className="text-black bg-[#9EAFA0] hover:bg-[#8E9F90] font-medium rounded-full text-sm px-7 py-2.5 text-center inline-flex items-center shadow-[4px_4px_8px_rgba(0,0,0,1)] transition duration-300 border-2 border-black"
          >
            Learn More
